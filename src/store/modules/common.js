export default {
  ...
  state: () => ({
    isLogin: uni.getStorageSync("isLogin")
      ? uni.getStorageSync("isLogin")
      : false, //是获取的目前的周数，不改变
    //keyValue:0,
    toastIsShow: false,
    backgroundImage: uni.getStorageSync("backgroundImage")
      ? uni.getStorageSync("backgroundImage")
      : "",
    isGraduateStudent: uni.getStorageSync("isGraduateStudent")
      ? uni.getStorageSync("isGraduateStudent")
      : false, // 是否是研究生
    loginIsGraduteStudent: uni.getStorageSync("loginIsGraduteStudent")
      ? uni.getStorageSync("loginIsGraduteStudent")
      : false, // 登录时是否是研究生
  }),
  ...
  mutations: {
    ...
    setLoginIsGraduteStudent(state, payload) {
      state.loginIsGraduteStudent = payload.loginIsGraduteStudent;
      uni.setStorageSync(
        "loginIsGraduteStudent",
        payload.loginIsGraduteStudent
      );
      console.log(
        "研究生登录成功6665",
        uni.getStorageSync("loginIsGraduteStudent")
