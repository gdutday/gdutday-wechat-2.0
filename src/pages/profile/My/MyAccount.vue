...
import {getMockData} from '@/utils/convert/student-v2/test.js'
...
export default {
	...
	setup(props) {
		...
		const refreshExam = loginIsGraduteStudent ? debounce(_getPastExamAPIExamInfoGraduate, 1500) : debounce(
