<template>
  ...
  >
    ...
    <view class="message-container p-2">
      ...
      <view class="h-1 w-1 flex-center my-5 overflow-hidden">
...
import { postPageLimit } from "@/network/ssxRequest/ssxInfo/qianxun.js";
export default {
  components: {
    Ztl,
    WatchButton,
  ...
  setup() {
    ...
    //******************************************* */
    //控制切换
    const array = ref(["所有千寻", "我的千寻", "丢失千寻", "拾取千寻"]);
    let index = ref(0);
